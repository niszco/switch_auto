 ...
 */
final class Version20240123144858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE energy_type_vehicle (energy_type_id INT NOT NULL, vehicle_id INT NOT NULL, INDEX IDX_55ED806C80726647 (energy_type_id), INDEX IDX_55ED806C545317D1 (vehicle_id), PRIMARY KEY(energy_type_id, vehicle_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, brand_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, vehicle_condition VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, price INT NOT NULL, localisation VARCHAR(255) NOT NULL, color ENUM(\'Orange\', \'Noir\', \'Gris clair\') NOT NULL COMMENT \'(DC2Type:color_enum)\', type_of_vehicle ENUM(\'4X4\', \'Citadine\', \'Berline\', \'Break\', \'Utilitaires\', \'Sans Permis\') NOT NULL COMMENT \'(DC2Type:type_of_vehicle_enum)\', car_mileage VARCHAR(255) NOT NULL, gearbox_type ENUM(\'Boîte Manuelle\', \'Boîte Automatique\', \'Boîte Automatique Pilotée\') NOT NULL COMMENT \'(DC2Type:gearbox_type_enum)\', finishes VARCHAR(255) NOT NULL, length VARCHAR(50) DEFAULT NULL, width VARCHAR(50) DEFAULT NULL, tire_spec VARCHAR(150) DEFAULT NULL, year INT NOT NULL, images VARCHAR(255) NOT NULL, number_of_seats VARCHAR(30) NOT NULL, number_of_doors VARCHAR(30) NOT NULL, horsepower VARCHAR(30) NOT NULL, fiscal_horse_power VARCHAR(30) NOT NULL, co2_emissions VARCHAR(30) DEFAULT NULL, energy_consumption VARCHAR(30) NOT NULL, INDEX IDX_1B80E48644F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL, available_at DATETIME NOT NULL, delivered_at DATETIME DEFAULT NULL, INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE energy_type_vehicle ADD CONSTRAINT FK_55ED806C80726647 FOREIGN KEY (energy_type_id) REFERENCES energy_type (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE energy_type_vehicle ADD CONSTRAINT FK_55ED806C545317D1 FOREIGN KEY (vehicle_id) REFERENCES vehicle (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE energy_type_vehicle DROP FOREIGN KEY FK_55ED806C80726647');
        $this->addSql('ALTER TABLE energy_type_vehicle DROP FOREIGN KEY FK_55ED806C545317D1');
